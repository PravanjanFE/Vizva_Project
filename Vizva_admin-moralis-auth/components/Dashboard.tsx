...
export default function Dashboard() {
  ...
  } = useMoralisCloudFunction("getAllOnAuctionItems");
  const {
    data: instantSale,
    error: instantSaleError,
    isLoading: instantSaleLoading,
  } = useMoralisCloudFunction("getAllOnSaleItems");

  let arr = []
  if(liveAuction!==null && instantSale!==null){
    arr = [
        ...JSON.parse(JSON.stringify(liveAuction)),
        ...JSON.parse(JSON.stringify(instantSale)),
      ].map((nft) => nft.createdBy.username);
  }

  const usersWithNFTs = Array.from(new Set(arr));
  const newUsers = 0;
  const reportedUsers = 0;
  const totalUsers = allUserData ? (allUserData as []).length : 0;
  return (
    <div>
            ...
            <div className="row">
              ...
              <div className="col-lg-3 col-6">
                <div className="small-box bg-warning">
                  <div className="inner">
                    <h3>{usersWithNFTs.length}</h3>
                    <p>Users with NFT created</p>
                  </div>
                  <div className="icon">
                                    ...
                                    <div className="card-body">
                                        <div className="direct-chat-messages">
                                            <div className="direct-chat-msg">
                                                ...
                                                <Image className="direct-chat-img" src="/static/distimg/user1-128x128.jpg" alt="message user image" />
                                            ...
                                            <div className="direct-chat-msg right">
                                                ...
                                                <Image className="direct-chat-img" src="/static/distimg/user3-128x128.jpg" alt="message user image" />
                                                <div className="direct-chat-text">
                                        ...
                                        <div className="direct-chat-contacts">
                                            <ul className="contacts-list">
                                                <li>
                                                    <a href="#">
                                                        <Image className="contacts-list-img" src="/static/distimg/user1-128x128.jpg" alt="User Avatar" />
                                                        <div className="contacts-list-info">
                                                            <span className="contacts-list-name">
                                                                Count Dracula
                                                                <small className="contacts-list-date float-right">2/28/2015</small>
                                                            </span>
                                                            <span className="contacts-list-msg">How have you been? I
                                                                was...</span>
                                                        </div>
                                                    </a>
                                                </li>
                                                <li>
                                                    <a href="#">
                                                        <Image className="contacts-list-img" src="/static/distimg/user7-128x128.jpg" alt="User Avatar" />
                                                        <div className="contacts-list-info">
                                                            <span className="contacts-list-name">
                                                                Sarah Doe
                                                ...
                                                <li>
                                                    <a href="#">
                                                        <Image className="contacts-list-img" src="/static/distimg/user3-128x128.jpg" alt="User Avatar" />
                                                        <div className="contacts-list-info">
                                                            <span className="contacts-list-name">
                                                                Nadia Jolie
                                                ...
                                                <li>
                                                    <a href="#">
                                                        <Image className="contacts-list-img" src="/static/distimg/user5-128x128.jpg" alt="User Avatar" />
                                                        <div className="contacts-list-info">
                                                            <span className="contacts-list-name">
                                                                Nora S. Vans
                                                ...
                                                <li>
                                                    <a href="#">
                                                        <Image className="contacts-list-img" src="/static/distimg/user6-128x128.jpg" alt="User Avatar" />
                                                        <div className="contacts-list-info">
                                                            <span className="contacts-list-name">
                                                                John K.
                                                ...
                                                <li>
                                                    <a href="#">
                                                        <Image className="contacts-list-img" src="/static/distimg/user8-128x128.jpg" alt="User Avatar" />
                                                        <div className="contacts-list-info">
                                                            <span className="contacts-list-name">
                                                                Kenneth M.
                                    ...
                                    <div className="card-body">
                                        <ul className="todo-list" data-widget="todo-list">
                                            <li>
                                                ...
                                                <small className="badge badge-danger"><i className="far fa-clock" /> 2
                                                    mins</small>
                                                <div className="tools">
                                            ...
                                            <li>
                                                ...
                                                <small className="badge badge-warning"><i className="far fa-clock" /> 1
                                                    day</small>
                                                <div className="tools">
                                                    <i className="fas fa-edit" />
                                                    <i className="fas fa-trash-o" />
                                            ...
                                            <li>
                                                ...
                                                <span className="text">Let theme shine like a star</span>
                                                <small className="badge badge-success"><i className="far fa-clock" /> 3
                                                    days</small>
                                                <div className="tools">
                                                    <i className="fas fa-edit" />
                                                    <i className="fas fa-trash-o" />
                                            ...
                                            <li>
                                                ...
                                                <small className="badge badge-primary"><i className="far fa-clock" /> 1
                                                    week</small>
                                                <div className="tools">
                                                    <i className="fas fa-edit" />
                                                    <i className="fas fa-trash-o" />
