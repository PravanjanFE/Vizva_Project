...
export default function AddPerson() {
    ...
    const [selRole, setSelRole] = React.useState('admin');
    ...
    const createAdmin = async (e: React.FormEvent<HTMLFormElement>) => {
        ...
        const result = await Moralis.Cloud.run('createNewAdminUser', { email: email, role: role, pages: pagesAllowed });
        alert(result.msg);
                    ...
                    <div className="container-fluid">
                        <div className="row mb-2">
                            <div className="col-sm-6">
                                <h1 className="m-0">Control Panel/Access/Add Person</h1>
                            </div>
                            {/* <div className="col-sm-6">
                                ...
                                <div className="col-md-6 d-flex flex-column">
                                    <div className="card">
                                        ...
                                        <div className="card-body">
                                            <div className="form-group">
                                                <label>Role:</label>
                                                <select name="role" className="form-select" onChange={e => setSelRole(e.target.value)}>
                                                    ...
                                                    <div className='d-flex flex-wrap'>
                                                        {pages.map((page, index) => {
                                                            return <div className="form-check col-md-4" key={index}>
                                                                <input name="page" className="form-check-input" type="checkbox" value={page} />
